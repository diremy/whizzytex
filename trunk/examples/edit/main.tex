...
\editcirclenode{x=9.0160,y=8.3941,w=6.1526}
  [boxsep=0pt,framesep=0pt,fillstyle=solid,fillcolor=cyan]{A}%
  {Left \\adjusted\\ circle}%
\editcirclenode*{x=27.0628,y=10.3129,w=2.6665}
   [boxsep=0pt,framesep=0pt,fillstyle=solid,fillcolor=cyan]%
   {A}{Centered\\ circle}%

\newcommand{\editovalnode}[1]{\@ifnextchar [{\editovalnode@i{#1}}
{\editovalnode@ii{#1}{}}}
\def \editovalnode@i#1[#2]{\editovalnode@ii{#1}{#2}}
\def \editovalnode@ii#1#2#3#4%
 {\adviedit{comm=\editovalnode,#1}%
  {\hskip -\adviw\ovalnode[#2]{#3}{\hspace{2\adviw}}\hskip -\adviw
   \hbox to 0em{\hss \begin{tabular}{c}#4\end{tabular}\hss}%
  }}%
\adviedit{x=17.4847,y=-1.7498,w=4.0624}
  {\hsize \adviw\vbox{aa kj lkj lkjkl ljk jjklj klj  
\adviedit{x=7.6260,y=4.1626,w=3.2017}
  {\circlenode{A}{\hspace{\adviw}}}%
aa a aj lkljk lj l lk }}%
%
\adviedit{x=4.7123,y=-4.7513,w=6.2238}
  {\hsize \adviw\vtop{aa kj lkj lkjkl ljk jjklj klj  aa a aj lkljk lj l lk
  }}%
%
\adviedit{x=28.6825,Y=-5.8014,w=6.7067,h=3.6332,d=5.1069}
...
\adviedit{x=24.1928,y=-4.2045,w=7.5512}
 {\ovalnode{A}
...
\adviedit{w=1.0043,h=1.0513,d=0.3946,unit=4em}
...
\adviedit{x=0.2693,y=0.0037,w=0.3989,unit=\hsize}{%
...
\adviedit{x=4.8001,y=-1.7651,w=1.5628,h=0.8366}{\caml}%
\adviedit{x=1.1410,y=-0.9226,w=1.1661,h}{\caml}%e
\adviedit{x=0.1224,y=-1.5206,w=1.4992,h=1.3165}{\caml}%
...
{\setedit{unit=\hsize}%
 \vbox{%
 \hbox{R: \adviedit[R]{w=0.8096}{\xdef\R{\advicw}\hfil}}%
 \hbox{G: \adviedit[G]{w=0.7593}{\xdef\G{\advicw}}}%
 \hbox{B: \adviedit[B]{w=0.8033}{\xdef\B{\advicw}}}%
...
\qquad 
\editbubble{w=10.8781,h=1.7503}
{\editbubble{w=3.4823,h=2.3381}
            {\editbubble{w=-0.4397,h=1.5079}{anchor}{first}}
            {second}}
          {third}
