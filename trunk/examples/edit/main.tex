...
\editcirclenode{x=7.0916,y=6.7597,w=5.5770}
  [boxsep=0pt,framesep=0pt,fillstyle=solid,fillcolor=cyan]{A}%
  {Left \\adjusted\\ circle}%
\editcirclenode*{x=24.6966,y=7.6779,w=2.6665}
...
\adviedit{x=16.9091,y=-2.9009,w=4.0624}
...
%
\adviedit{x=24.0779,Y=-5.8014,w=6.7067,h=3.6332,d=5.1069}
...
\adviedit{x=0.2693,y=0.0037,w=0.4029,unit=\hsize}{%
...
\adviedit{x=4.7159,y=-1.4110,w=1.4785,h=0.8872}{\caml}%
