...
This dream is becoming reality...

Some edition such as repositioning and resizing of 
{\tt boxes}, {\tt minipages} and {\tt glue} can already be 
done in {\whizzy} provided you have a recent version of Active-DVI. 

See the example {\tt example/edit/main.tex} and the package
{\tt example/edit/whizzedit.sty}
