...
Siniscalchi reported that it successfully worked on his Window plateform
under Cygwin (1.5.5-1), using \texttt{Cygwin/Xfree 4.3} and \texttt{xdvi}
from \texttt{tetex 2.0.2-13}.
