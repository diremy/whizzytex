...
{\WhizzyTeX} is designed for \lst"Unix" plateforms.  However, it has been
reported to successfully work on Windows under Cygwin (1.5.5-1), using
\texttt{Cygwin/Xfree 4.3} and \texttt{xdvi} from \texttt{tetex 2.0.2-13}.

Two tricks are necessary:
\begin{itemize}
...
\end{itemize}
Unfortunately, xdvi is very slow, so this is not very practical. 
